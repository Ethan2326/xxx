...
api_router.include_router(prescripteurs_router, prefix="/prescripteurs", tags=["Annuaire prescripteurs"])
api_router.include_router(billing_router,      prefix="/billing",       tags=["Devis & Factures"])
